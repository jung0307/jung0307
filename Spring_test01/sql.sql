...
insert into freeboard values('guest' ,1234 ,5 , 0,sysdate,'안녕하세요1',null,'익명게시판1',0)
insert into freeboard values('guest' ,1234 ,6 , 0,sysdate,'안녕하세요2',null,'익명게시판2',0)
insert into freeboard values('guest' ,1234 ,7 , 0,sysdate,'안녕하세요3',null,'익명게시판3',0)
insert into freeboard values('guest' ,1234 ,8 , 0,sysdate,'안녕하세요4',null,'익명게시판4',0)
insert into freeboard values('guest' ,1234 ,9 , 0,sysdate,'안녕하세요5',null,'익명게시판5',0)
insert into freeboard values('guest' ,1234 ,10 , 0,sysdate,'안녕하세요6',null,'익명게시판6',0)
insert into freeboard values('guest' ,1234 ,11 , 0,sysdate,'안녕하세요7',null,'익명게시판7',0)
