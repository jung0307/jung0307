...
<div id="container">
	<c:choose>
		<c:when test="${logIn == 'on'}">
			<form action="${contextPath}/board/rewriteBoardContent.do" method="post" enctype="multipart/form-data"> 
				<table border="1" style="width:100%; border-collapse: collapse;">
					<tr style="border-bottom: soild; border-bottom-color: #cccccc; border-bottom-width: 0.5px;">
						<td style="width:70%" class="td_header"> <input type="text" style="width: inherit;" class="form-control" name="boardTitle" value="${boardVO.boardTitle }"> </td>
...
function rewrite() {
	alert('와우');
	form.action = "${contextPath}/board/rewriteBoardContent.do";
	form.method = "POST";
	form.submit();
} */
