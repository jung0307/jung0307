...
public class CommentVO {
	...
	public int getCommentPwd() {
		return commentPwd;
	}

	public void setCommentPwd(int commentPwd) {
	...
	public CommentVO(String commentID, String commentContent, String commentDate, int commentGroup, int commentHir,
			int commentNum, int boardNum, int commentCount, int commentPwd, String role) {
