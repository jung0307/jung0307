...
public class Paging {
	...
	public String pagination(int pagingBlock,int pagingNum, int totalBlock, int totalNum,String searchSection
			,String searchText,HttpServletRequest req,String path) {
		...
		//totalBlock 전체 게시물을 pagingBlock으로 나눈 수
		//totalNum 전체 게시물의 숫자 
		...
		if(searchText.equals("")) {
			...
			if(pagingNum != 1 ) {
				pagingMessage = pagingMessage + "<li class='page-item'>"
						...
						+ req.getContextPath()
						+"/"+path+"/getBoardList?pagingNum=1'>&laquo;</a></li>";
			}
			...
			while(blockNum <= pagingBlock && pagingTemp < totalBlock) {
				if(pagingTemp == pagingNum) {
					pagingMessage = pagingMessage + "<li class='page-item'>"
							+ "<a class='page-link' href='"
							+ req.getContextPath()
							+ "/"+path+"/getBoardList?pagingNum="+pagingTemp+"'>"+pagingTemp+"</a></li>";	
				}else {
					pagingMessage = pagingMessage + "<li class='page-item'>"
							+ "<a class='page-link' href='"
							+ req.getContextPath()
			...
			if(pagingTemp<totalBlock) {
				pagingMessage = pagingMessage + "<li class='page-item'>"
						+ "<a class='page-link' href='"
						+ req.getContextPath()
						+ "/"+path+"/getBoardList?pagingNum="+pagingTemp+"'>&raquo;</a></li>";	
		...
		// searchText가 있을 때
			...
			if(pagingNum != 1 ) {
				pagingMessage = pagingMessage + "<li class='page-item'>"
						+ "<a class='page-link' href='"
						+ req.getContextPath()
						+"/"+path+"/getBoardList?pagingNum=1&searchSection="+searchSection+"&searchText="+searchText+"'>&laquo;</a></li>";
			}
			...
			while(blockNum <= pagingBlock && pagingTemp < totalBlock) {
				if(pagingTemp == pagingNum) {
					pagingMessage = pagingMessage + "<li class='page-item'>"
							+ "<a class='page-link' href='"
							+ req.getContextPath()
							+ "/"+path+"/getBoardList?pagingNum="+pagingTemp+"&searchSection="+searchSection+"&searchText="+searchText+"'>"+pagingTemp+"</a></li>";	
				}else {
					pagingMessage = pagingMessage + "<li class='page-item'>"
							+ "<a class='page-link' href='"
							+ req.getContextPath()
			...
			if(pagingTemp<totalBlock) {
				pagingMessage = pagingMessage + "<li class='page-item'>"
						+ "<a class='page-link' href='"
						+ req.getContextPath()
						+ "/"+path+"/getBoardList?pagingNum="+pagingTemp+"&searchSection="+searchSection+"&searchText="+searchText+"'>&raquo;</a></li>";	
			}else if(pagingTemp == totalBlock) {
				pagingMessage = pagingMessage + "<li class='page-item'>"
						+ "<a class='page-link' href='"
						+ req.getContextPath()
