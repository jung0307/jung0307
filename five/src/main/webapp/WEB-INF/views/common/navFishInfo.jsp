...
<!--         <li class="nav-item dropdown">
      ...
      <form class="d-flex" action="${contextPath }/fishInfo/getFishInfoMain.do" method="get">
		<select class="form-control me-sm-2" style="width: 120px;" name="searchSection" id="searchSection">
			<option value='' disabled>section</option>
			<option value='fishNum'>fishNum</option>
