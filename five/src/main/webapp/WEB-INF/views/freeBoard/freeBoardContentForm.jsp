...
<%-- <c:choose>
				...
				<table border="1" style="width:100%; border-collapse: collapse;">
					...
					<tr style="border-bottom: soild; border-bottom-color: #cccccc; border-bottom-width: 0.5px;">
						<td class="td_header" colspan="3" style="padding: 15px;">  
							<input type="button" class="btn btn-primary" id="submitBTN" onclick="submit(this.form);" value="등록"></input>
		...
		<c:otherwise>
			...
			<form action="${contextPath }/freeBoard/uploadBoardContent.do" method="post" enctype="multipart/form-data" onsubmit="return valid(form);"> 
				<table border="1" style="width:100%; border-collapse: collapse;">
					<tr style="border-bottom: soild; border-bottom-color: #cccccc; border-bottom-width: 0.5px;">
						<td style="width:50%; max-width: 50%;" class="td_header"> <input type="text" style="width: 400px;" class="form-control" name="boardTitle" required="required" placeholder="title"> </td>
					 	<td style="width:20%; max-width: 20%;" class="td_header"> <input type="password" style="width: 100px; margin-left: 50px;" class="form-control" name="boardPwd" required="required" placeholder="password"> </td>				
